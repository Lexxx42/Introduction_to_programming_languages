...
for i in range(number_of_coordinates):
    ...
    if input_coords[0] in directions:
        ...
        directions[input_coords[0]] = int(input_coords[1])
if directions.get("юг") is None:
    directions["юг"] = 0
if directions.get("север") is None:
    directions["север"] = 0
if directions.get("запад") is None:
    directions["запад"] = 0
if directions.get("восток") is None:
    directions["восток"] = 0
print(f'{directions.get("восток") - directions.get("запад")} {directions.get("север") - directions.get("юг")}')
