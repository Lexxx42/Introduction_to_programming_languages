...
# Второе пространство имен, которое создается - это пространство имен main, оно является глобальным
...
def fun():
    ...
    x = 1
    # ...
# На глобальном уровне мы объявили переменную а и мы объявили имя fun. Они и попадут в неймспейс main
