...
# Вам необходимо установить библиотеку simple-crypt,
# и с помощью метода simplecrypt.decrypt узнать,
...
# Примечание:
# Работа с файлами рассмотрена в следующем уроке,
# поэтому вы можете вернуться к этой задаче после просмотра следующего урока.
...
with open("passwords.txt") as passwords:
    for line in passwords:
        password = line.strip()
        try:
            my_string = decrypt(password, encrypted).decode('utf8')
            print(my_string)
            break
        except:
            print(password)
