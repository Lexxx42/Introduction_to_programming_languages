...
# В данной задаче гарантируется,
# что в качестве аргумента x метода append всегда будет передаваться целое число.
...
positive_list = PositiveList([1, 2, 3])
positive_list.append(-5)
print(positive_list)
